...
class Notification extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new NotificationState(refresh);
  }
}
...
class NotificationState extends State<Notification> {
  ...
  NotificationState(this.refresh);
  ...
  void initState() {
    ...
    _refreshControllerNotification = RefreshController(initialRefresh: refresh);
  }
...
//    get notification from database
    ...
    List item = await (db.getRequestByRange(_userId));
